...
- **Datos de Salud** se refiere a cualquier información relacionada con su salud física o mental, incluyendo información sobre tratamientos dentales, historial médico, diagnósticos y cualquier otra información de salud recopilada durante su tratamiento.

- **Servicio** se refiere al Sitio Web.

- **Proveedor de Servicios** significa cualquier persona natural o jurídica que procesa los datos en nombre de la Clínica. Se refiere a empresas o individuos de terceros empleados por la Clínica para facilitar el Servicio, proporcionar el Servicio en nombre de la Clínica, realizar servicios relacionados con el Servicio o ayudar a la Clínica a analizar cómo se utiliza el Servicio.

- **Datos de Uso** se refiere a los datos recopilados automáticamente, ya sea generados por el uso del Servicio o desde la propia infraestructura del Servicio (por ejemplo, la duración de una visita a la página).
...
- Dirección postal
- Información de salud dental (cuando se proporciona a través de formularios de contacto o consultas)
- Cualquier otra información que elija proporcionarnos

#### Datos de Salud

Como clínica dental, podemos recopilar y procesar información relacionada con su salud dental cuando:

- Solicita una consulta o cita
- Completa formularios de contacto relacionados con tratamientos dentales
- Se comunica con nosotros sobre servicios dentales

Esta información se procesa de acuerdo con las leyes de protección de datos aplicables, incluyendo el Reglamento General de Protección de Datos (RGPD) y la legislación española sobre protección de datos de salud.
...
- **Cookies o Cookies del Navegador.** Una cookie es un pequeño archivo colocado en su Dispositivo. Puede instruir a su navegador para que rechace todas las Cookies o para que indique cuando se está enviando una Cookie. Sin embargo, si no acepta las Cookies, es posible que no pueda usar algunas partes de nuestro Servicio. A menos que haya ajustado la configuración de su navegador para que rechace las Cookies, nuestro Servicio puede usar Cookies.
...
- **Para cumplir con obligaciones legales y regulatorias:** Como clínica dental, debemos cumplir con las leyes y regulaciones aplicables relacionadas con el mantenimiento de registros médicos y la protección de datos de salud.
...
- **Para cumplir con obligaciones legales:** Podemos divulgar su información personal si la ley lo requiere o en respuesta a solicitudes válidas de autoridades públicas (por ejemplo, un tribunal o una agencia gubernamental).
...
Para datos de salud, la Clínica está obligada por ley a retener registros médicos durante períodos específicos según la legislación española aplicable. Los registros médicos generalmente se retienen durante al menos 5 años desde la última visita, o según lo requiera la ley.

La Clínica también retendrá Datos de Uso para fines de análisis interno. Los Datos de Uso generalmente se retienen por un período de tiempo más corto, excepto cuando estos datos se usan para fortalecer la seguridad o para mejorar la funcionalidad de nuestro Servicio, o estamos legalmente obligados a retener estos datos por períodos de tiempo más largos.
...
Si desea obtener información sobre qué Datos Personales tenemos sobre usted y si desea que se eliminen de nuestros sistemas, contáctenos.
...
Puede actualizar, modificar o eliminar su información en cualquier momento contactándonos para solicitar acceso, corrección o eliminación de cualquier información personal que nos haya proporcionado.

Tenga en cuenta, sin embargo, que podemos necesitar retener cierta información cuando tenemos una obligación legal o base legal para hacerlo, especialmente en relación con registros médicos que deben mantenerse según la ley.
...
Bajo ciertas circunstancias, la Clínica puede estar obligada a divulgar sus Datos Personales si la ley lo requiere o en respuesta a solicitudes válidas de autoridades públicas (por ejemplo, un tribunal o una agencia gubernamental).

#### Otros requisitos legales

La Clínica puede divulgar sus Datos Personales con la creencia de buena fe de que tal acción es necesaria para:

- Cumplir con una obligación legal
- Proteger y defender los derechos o la propiedad de la Clínica
...
Implementamos medidas de seguridad técnicas y organizativas apropiadas para proteger sus Datos Personales contra acceso no autorizado, alteración, divulgación o destrucción. Estas medidas incluyen, entre otras:
...
No tenemos control sobre y no asumimos responsabilidad por el contenido, las políticas de privacidad o las prácticas de ningún sitio o servicio de terceros.
